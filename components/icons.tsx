...
// Create and export SVG icon components.
...
export const Google: React.FC<IconProps> = (props) => (
	...
	C42.018,35.244,44,30.028,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
    </svg>
);
...
export const Rocket: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a14.95 14.95 0 00-5.84-2.56m0 0a14.95 14.95 0 01-5.84-2.56m5.84 2.56v-4.82m0 0a6 6 0 015.84-7.38m-5.84 7.38l-3.36-3.36m3.36 3.36l3.36 3.36" />
    </svg>
);
...
export const QrCode: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 15.75h3.375M14.25 18h3.375M14.25 20.25h3.375M17.625 15.75v4.5" />
  </svg>
);
...
export const Lightbulb: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a7.5 7.5 0 01-7.5 0c-1.453 0-2.824.42-3.956 1.168M12 3c1.955 0 3.823.401 5.408 1.13M12 21h.008v.008H12V21z" />
    </svg>
);

export const Trophy: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 01-4.874-1.971 2.25 2.25 0 01-.546-1.057 2.25 2.25 0 011.057-.546 9.75 9.75 0 011.971-4.874 2.25 2.25 0 011.057-.546c.394-.093.79-.174 1.185-.242a2.25 2.25 0 01.546-1.057 9.75 9.75 0 014.874-1.971 2.25 2.25 0 011.057.546c.394.093.79.174 1.185.242a2.25 2.25 0 011.057.546 9.75 9.75 0 011.971 4.874 2.25 2.25 0 01-.546 1.057 9.75 9.75 0 01-1.971 4.874 2.25 2.25 0 01-1.057.546A18.02 18.02 0 0116.5 18.75z" />
    </svg>
);
...
export const Dollar: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.21 12.77 11 12 11h-2.25m0 0l-.879-.659a2.25 2.25 0 010-3.182c1.171-.879 3.07-.879 4.242 0C13.536 7.21 14.3 7.5 15 8.25" />
    </svg>
);
...
export const Refresh: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.992 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-11.664 0l-4.661 4.661M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);

// New Icons for Reasoning Panel
